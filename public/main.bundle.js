...
var AppComponent = (function () {
    function AppComponent(http) {
        ...
        this.app_url = "https://angramtest.azurewebsites.net:443";
        this.t1 = 0;
    }
    ;
    ...
    AppComponent.prototype.deleteUserProfile = function (_id) {
        ...
        return this.http.delete('/api/userProfile/' + _id).subscribe(function (res) {
        });
    };
